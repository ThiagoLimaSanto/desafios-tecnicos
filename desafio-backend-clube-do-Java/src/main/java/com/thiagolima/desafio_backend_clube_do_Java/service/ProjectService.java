...
public class ProjectService {
    ...
    public ProjectResponse createProject(ProjectRequest request) {
        ...
        return new ProjectResponse(project.getId(), project.getTitle(), project.getDescription(), project.getDeadline(),
    ...
    public List<ProjectResponse> getProjects() {
        return projectRepository.findAll().stream()
                .map(project -> new ProjectResponse(project.getId(), project.getTitle(), project.getDescription(),
                        project.getDeadline(),
                        project.getEstimatedBudget()))
                .toList();
    }
